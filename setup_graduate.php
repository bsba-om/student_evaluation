...
<head>
    ...
    <style>
        ...
        .header {
            ...
            margin-bottom: 24px; text-align: center; box-shadow: var(--shadow);
        }
...
function loadFolderStructure() {
    postForm('action=get_folder_structure')
        .then(r => r.text())
        .then(html => { document.getElementById('folder-structure-host').innerHTML = html; });
}
...
document.addEventListener('DOMContentLoaded', () => loadGraduates());
</script>
</body>
</html>
